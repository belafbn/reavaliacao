...
public class ControleUsuario implements Serializable {
    ...
    @EJB
    private DAOPermissao<Permissao> daoPermissao;
    ...
    public DAOPermissao<Permissao> getDaoPermissao() {
        return daoPermissao;
    }

    public void setDaoPermissao(DAOPermissao<Permissao> daoPermissao) {
